...
class m200724_223552_create_booking_tours_calendar_cost_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex('{{%idx-booking_tours_calendar_cost-tour_id}}', '{{%booking_tours_calendar_cost}}','tour_id');
        $this->addForeignKey('{{%fk-booking_tours_calendar_cost-tour_id}}', '{{%booking_tours_calendar_cost}}', 'tour_id', '{{%booking_tours}}', 'id', 'SET NULL', 'RESTRICT');
