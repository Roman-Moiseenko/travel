...
class m200724_102012_create_booking_tours_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%booking_tours}}', [
            ...
            'params_begin_town' => $this->string(),
            'params_begin_street' => $this->string(),
            'params_begin_house' => $this->string(),
            'params_begin_latitude' => $this->string(),
            'params_begin_longitude' => $this->string(),
            'params_end_town' => $this->string(),
            'params_end_street' => $this->string(),
            'params_end_house' => $this->string(),
