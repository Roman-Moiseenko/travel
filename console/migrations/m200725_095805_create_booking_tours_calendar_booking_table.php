...
class m200725_095805_create_booking_tours_calendar_booking_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex('{{%idx-booking_tours_calendar_booking-calendar_id}}', '{{%booking_tours_calendar_booking}}','calendar_id');

        $this->addForeignKey('{{%fk-booking_tours_calendar_booking-calendar_id}}', '{{%booking_tours_calendar_booking}}', 'calendar_id', '{{%booking_tours_calendar_cost}}', 'id', 'CASCADE', 'RESTRICT');
