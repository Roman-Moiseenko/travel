        ...
        <div class="card mt-3 <?= ($i % 2 == 0) ? 'bg2' : 'bg1' ?>" style="border: 0 !important; border-radius: 12px">
            ...
            <div class="card-body">
                ...
                <div class="d-flex pt-2">
                    <div class="ml-auto">
                        <a href="<?= Url::to(['/forum/post', 'id' => $post->id, '#' => 'top'], true); ?>"
                    ...
                    <?php if ($user): ?> <!-- Если авторизован-->
                        ...
                        <?php else: ?>
                            ...
                            ->widget(WysiBBWidget::class, [
                                ...
                                'clientOptions' => [
                                    'minheight' => '200',
                                    'buttons' =>"bold,italic,underline,strike,|,img,link,|,bullist,numlist,|,fontcolor,fontsize,|,justifyleft,justifycenter,justifyright,|,quote,removeFormat",
                                ],
                            ]) ?>
