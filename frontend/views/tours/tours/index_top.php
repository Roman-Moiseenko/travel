    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 14px; line-height: 2.5;">
                ...
                <br><span><?= Lang::t('Если вы предоставляете какие либо услуги по экскурсиями, турам и другим мероприятиям из туризма/отдыха, предоставляете автосредства в прокат, Вы можете зарегистрироваться на нашем портале по адресу') ?> <a
