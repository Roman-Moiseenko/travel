    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="well">
                ...
                <p><?= Lang::t('Создав учетную запись, вы сможете совершать покупки быстрее, быть в курсе состояния заказа и
                    отслеживать ранее сделанные заказы.') ?></p>
                <a href="/signup" class="btn btn-primary"><?= Lang::t('Продолжить') ?></a>
            </div>
            <div class="well">
                <p><strong><?= Lang::t('Войти через социальные сети') ?></strong></p>
                <p><?= Lang::t('Зарегистрировавшись через социальные сети, не забудьте добавить email и телефон для оповещения о статусе Ваших заказов.')?></p>
