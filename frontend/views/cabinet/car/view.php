...
<?= Lang::t('Организатор проката обеспечивает безопасность каждого транспортного срдства - гарантирует, что сдаваемое в прокат транспортное средство безопасно. А так же, в случае необходимости имеет страховой полис.') ?>
            <p>
