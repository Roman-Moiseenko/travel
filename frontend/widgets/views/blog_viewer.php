...
<div class="row">
    <div class="col p-1">
        <div class="card text-white shadow-lg" style="border: 0 !important; ">
            <img src="<?= $posts[0]->getThumbFileUrl('photo', $mobile ? 'widget_mobile' : 'widget_top') ?>" class="card-img" alt="<?= $posts[0]->getTitle() ?>"  title="<?= $posts[0]->getTitle() ?>">
...
<div class="row">
    <?php for ($i = 1; $i < $count; $i++): ?>
        <div class="col-sm-4 px-1">
            <div class="card text-white shadow-lg" style="border: 0 !important; ">
                <img src="<?= $posts[$i]->getThumbFileUrl('photo', $mobile ? 'widget_mobile' : 'widget_bottom') ?>" class="card-img" alt="<?= $posts[$i]->getTitle() ?>"  title="<?= $posts[$i]->getTitle() ?>">
                <div class="card-img-overlay">
