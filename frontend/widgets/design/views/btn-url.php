...
<div class="d2-btn-box">
    <a class="d2-btn <?= $block ? 'd2-btn-block' : '' ?> d2-btn-main" href="<?= Html::encode($url) ?>" rel="nofollow"
       data-class-name="<?=$class_name_click?>" data-class-id="<?=$class_id_click?>" data-type-event="<?= CheckClickUser::CLICK_URL ?>">
