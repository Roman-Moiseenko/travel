...
<h2 class="pt-4">Преимущества работы с нами</h2>
<div class="py-3 landowner-main">
    ...
    <p>У нас одни из самых низких цен в регионе</p>
    <p>
        Наше Агентство оказывает помощь переезжающим на ПМЖ в Калининград:
    </p>
    <ul>
        <li>Можем построить дом под ключ</li>
        ...
        <li>Создаем УК для обслуживания всех коммуникаций и инженерных систем и поддержания порядка</li>
    </ul>
    <p>
