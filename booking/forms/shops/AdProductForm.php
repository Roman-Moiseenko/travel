 ...
 */
class AdProductForm extends CompositeForm
{
    public $name;
    public $name_en;
    public $description;
    ...
    public function __construct(AdProduct $product = null, $config = [])
    {
        if ($product) {
    ...
    public function rules()
    {
        return [
            ...
            [['weight', 'manufactured_id', 'category_id', 'cost', 'discount'], 'integer'],
