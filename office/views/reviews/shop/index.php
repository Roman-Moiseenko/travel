...
/* @var $searchModel office\forms\reviews\ReviewShopSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Отзывы на Магазины';
        ...
        <div class="card-body">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'shop_id',
                        'value' => function (ReviewShop $model) {
                            return Html::a($model->shop->name, ['/shops/view', 'id' => $model->shop_id]);
                        },
                        'label' => 'Магазин',
                        'format' => 'raw',
                        'options' => ['width' => '20%'],
                        'contentOptions' => ['data-label' => 'Магазин'],
                    ],
                    [
                        'attribute' => 'user_id',
                        'value' => function (ReviewShop $model) {
                    ...
                    ['class' => ActionColumn::class,
                        'template' => '{delete}',
                        'buttons' => [
                            'delete' => function ($url, ReviewShop $model, $key) {
                                if ($model->isActive()) {
