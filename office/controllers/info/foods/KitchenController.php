...
use booking\services\foods\KitchenService;
...
class KitchenController extends Controller
{
    ...
    public function __construct($id, $module, KitchenService $service, $config = [])
    {
    ...
    public function actionCreate()
    {
        ...
        if ($form->load(\Yii::$app->request->post()) && $form->validate()) {
            try {
                ...
                return $this->redirect(['info/foods/kitchen/index']);
