...
use booking\services\office\HelpManageService;
use office\forms\HelpSearch;
...
class HelpController extends Controller
{
    ...
    /**
     * @var HelpManageService
     */
    private $service;

    public function __construct($id, $module, HelpManageService $service, $config = [])
    {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id):? Help
    {
