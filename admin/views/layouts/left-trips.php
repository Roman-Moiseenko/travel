        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte3\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Проживание', 'icon' => 'laptop-house', 'url' => ['/trip/placement', 'id' => $this->params['id']], 'active' => $this->context->id == 'trip/placement'],
                    ['label' => 'Мероприятия', 'icon' => 'directions', 'url' => ['/trip/activity', 'id' => $this->params['id']], 'active' => $this->context->id == 'trip/activity'],
                    ...
                    ['label' => 'Бронирования', 'icon' => 'calendar-alt', 'url' => ['/trip/booking', 'id' => $this->params['id']], 'active' => $this->context->id == 'trip/booking',
                        'badge' => '<span class="right badge badge-info">'. TripHelper::getCountActiveBooking($this->params['id']) . '</span>'],
                    ['label' => 'Отзывы', 'icon' => 'comment-dots', 'url' => ['/trip/review', 'id' => $this->params['id']], 'active' => $this->context->id == 'trip/review',
