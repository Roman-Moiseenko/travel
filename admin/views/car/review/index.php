...
<div class="cars-view">
    <div class="row">
        <div class="col-md-6">
            <?= \frontend\widgets\RatingWidget::widget(['rating' => $car->rating]) ?>
            <?= count($car->reviews) . ' отзыва(ов)'?>
        </div>
        <div class="col-md-4">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="pl-2">
                        <a href="<?= Url::to(['cabinet/dialog/petition', 'id' => $review->id . BookingHelper::BOOKING_TYPE_CAR])?>" title="Подать жалобу"><i class="fas fa-share-square"></i></a>
                    </div>
                </div>
                <hr/>
                <div class="p-3">
