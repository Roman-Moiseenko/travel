    ...
    <div class="row">
        <div class="col d-flex">
            <div class="ml-auto booking-item">
                <a class="link-admin" href="<?= Url::to(['/cabinet/dialog/mass-stay', 'id' => $calendar->id]) ?>"
        ...
        <div class="card">
            ...
            <div class="collapse" id="collapse-<?= $i ?>">
                ...
                <span class="booking-item">
                    ...
                    <span class="booking-item">
                    <i class="fas fa-users"></i>&#160;&#160;<?= $booking->guest ?>
                </span>
                    <br>
                    <span class="booking-item">
                    ...
                    <?php if ($booking->isPay() || $booking->isConfirmation()): ?>
                        ...
                        <?php else: ?>
                            <span class="custom-control custom-checkbox">
                                <input id="giv-out-<?= $i ?>" class="custom-control-input give-out-stay" type="checkbox"
                                       value="1"
