...
<div class="category-index">
    <p>
        <?= Html::a('Создать Авто', Url::to('car/common/create'), ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'name',
                'value' => function (Car $model) {
                    return Html::a(Html::encode($model->name), ['/car/common', 'id' => $model->id]);
                },
                'format' => 'raw',
                'label' => 'Название',
                'options' => ['width' => '25%'],
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'view' => function ($url, $model, $key) {
                        $url = Url::to(['/car/common/index', 'id' => $model->id]);
